...
{
    public partial class FormRelatorioCompleto : FormGuard
    {
...
#pragma warning restore CS0246 // O nome do tipo ou do namespace "RenderingCompleteEventArgs" não pode ser encontrado (está faltando uma diretiva using ou uma referência de assembly?)
        ...
        public string MontarFiltros(Control.ControlCollection pControles)
        {
            ...
            foreach (Control ctrl in controlesOrdenados)
            {
                ...
                if (ctrl is System.Windows.Forms.Guard.ListaCampos && ((System.Windows.Forms.Guard.ListaCampos)ctrl).Checado())
                {
                    _filtrosUtilizados.Add(((System.Windows.Forms.Guard.ListaCampos)ctrl).TextCheck + ": " + ((System.Windows.Forms.Guard.ListaCampos)ctrl).RetornaLista().Replace("'", "").Replace(",", ", "));
                }

                //Tratamento do List Campos recursos genéricos
                if (ctrl is System.Windows.Forms.Guard.ListaCampos1 && ((System.Windows.Forms.Guard.ListaCampos1)ctrl).Checado())
                    _filtrosUtilizados.Add(((System.Windows.Forms.Guard.ListaCampos1)ctrl).TextCheck + ": " + ((System.Windows.Forms.Guard.ListaCampos1)ctrl).RetornaLista().Replace("'", "").Replace(",", ", "));
