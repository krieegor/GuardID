...
namespace System.Windows.Forms.Guard
{
    public partial class FormGuard : Form
    {
        ...
        {
            InitializeComponent();
            this.MdiChildActivate += new EventHandler(FormGuard_MdiChildActivate);
            this.Resize += new EventHandler(FormGuard_Resize);
            this.ResizeEnd += new EventHandler(FormGuard_Resize);
        }
        ...
        void FormGuard_MdiChildActivate(object sender, EventArgs e)
        {
        ...
        void FormGuard_Resize(object sender, EventArgs e)
        {
            if (!this._IsFormularioPrincipal && this.MdiParent != null)
            {
                FormWindowState f = ((FormGuard)sender).WindowState;
                            ...
                            foreach (Type type in types)
                            {
                                if (!type.FullName.Equals(this.GetType().FullName))
                                {
                                    try
                                    {
                                        ...
                                        {
                                            case "System.Windows.Forms.Guard.FormGuard":
                                                FormGuard frmGuard = (FormGuard)Activator.CreateInstance(type);
                                                ...
                                                break;
                                            case "System.Windows.Forms.Guard.FormCadastro":
                                                ...
                                                break;
                                            case "System.Windows.Forms.Guard.FormRelatorioCompleto":
                                                ...
                                                break;
                                            case "System.Windows.Forms.Guard.FormBusca":
                                                ...
                                                break;
                                            case "System.Windows.Forms.Guard.FormConsulta":
                                                ...
                                                break;
                                            case "System.Windows.Forms.Guard.FormAssistenteCadastro":
        ...
        private void PreencherPropriedades(FormGuard frm, List<string> propriedades, List<string> valores)
        {
            try
            {
        ...
        public void SetValorPropriedade(FormGuard frm, string nomeDaPropriedade, object valor)
        {
            System.Reflection.PropertyInfo prop = GetPropriedades(nomeDaPropriedade);

            prop.SetValue(frm, valor, null);
        }
        public object GetValorPropriedade(FormGuard frm, string nomeDaPropriedade)
        {
            System.Reflection.PropertyInfo prop = GetPropriedades(nomeDaPropriedade);
