    ...
    public partial class FormCadastro : FormBasic
    {
        ...
        private void BloquearTodosComponentes(Control.ControlCollection controls)
        {
            foreach (Control ctrl in controls)
            {
                ...
                if (ctrl is MaskedTextBoxDataGuard)
                {
                    ((MaskedTextBoxDataGuard)ctrl).Enabled = true;
                    ((MaskedTextBoxDataGuard)ctrl).ReadOnly = true;
                }
...
#pragma warning disable CS0108 // "FormCadastro.RegistroNaoEncontrado(TextBoxGuard)" oculta o membro herdado "FormBasic.RegistroNaoEncontrado(TextBoxGuard)". Use a nova palavra-chave se foi pretendido ocultar.
        public static void RegistroNaoEncontrado(TextBoxGuard txt)
#pragma warning restore CS0108 // "FormCadastro.RegistroNaoEncontrado(TextBoxGuard)" oculta o membro herdado "FormBasic.RegistroNaoEncontrado(TextBoxGuard)". Use a nova palavra-chave se foi pretendido ocultar.
        {
...
#pragma warning disable CS0108 // "FormCadastro.RegistroNaoEncontrado(MaskedTextBoxDataGuard)" oculta o membro herdado "FormBasic.RegistroNaoEncontrado(MaskedTextBoxDataGuard)". Use a nova palavra-chave se foi pretendido ocultar.
        public static void RegistroNaoEncontrado(MaskedTextBoxDataGuard txt)
#pragma warning restore CS0108 // "FormCadastro.RegistroNaoEncontrado(MaskedTextBoxDataGuard)" oculta o membro herdado "FormBasic.RegistroNaoEncontrado(MaskedTextBoxDataGuard)". Use a nova palavra-chave se foi pretendido ocultar.
        {
            if (IsFormClosing() == true)
                return;
...
#pragma warning disable CS0108 // "FormCadastro.MensagemCampoVazio(TextBoxGuard, string)" oculta o membro herdado "FormBasic.MensagemCampoVazio(TextBoxGuard, string)". Use a nova palavra-chave se foi pretendido ocultar.
        public static bool MensagemCampoVazio(TextBoxGuard txt, string mensagem)
#pragma warning restore CS0108 // "FormCadastro.MensagemCampoVazio(TextBoxGuard, string)" oculta o membro herdado "FormBasic.MensagemCampoVazio(TextBoxGuard, string)". Use a nova palavra-chave se foi pretendido ocultar.
        {
            if (IsFormClosing() == true)
                return false;
